...
class Zx1(unittest.TestCase):
    ...
    def test_zx1(self):
        ...
        driver.find_element_by_css_selector("li.open > a.dropdown-toggle > span.menu-text").click()
        ...
        driver.find_element_by_xpath("//div[@id='div_menu']/ul/li/a/span").click()

...
class Xtgl(unittest.TestCase):
    ...
    def test_xtgl(self):
        driver = self.driver
        driver.get(self.base_url + "/middleclient/;JSESSIONID=f534384d-a7e5-4ea1-b268-0eee078b5dfb")
        driver.find_element_by_css_selector("i.fa.fa-angle-down").click()
        driver.find_element_by_link_text(u"注销").click()
        Select(driver.find_element_by_id("platform")).select_by_visible_text(u"河南教育局")

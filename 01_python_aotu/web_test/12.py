...
class 12(unittest.TestCase):
    ...
    def test_12(self):
        ...
        driver.find_element_by_css_selector("div.col-sm-9.text-center > button.btn.btn-default").click()
        driver.find_element_by_id("choosearea").click()
        ...
        driver.find_element_by_id("choosearea").click()
        driver.find_element_by_xpath("//div[@id='treeview']/ul/li[3]").click()
        driver.find_element_by_css_selector("div.col-sm-9.text-center > #submit").click()
        driver.find_element_by_id("choosearea").click()
        driver.find_element_by_xpath("//div[@id='treeview']/ul/li[4]").click()
        driver.find_element_by_css_selector("div.col-sm-9.text-center > #submit").click()

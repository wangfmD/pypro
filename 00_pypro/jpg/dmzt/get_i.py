...
page = urllib.urlopen("http://www.mzitu.com/")
# page = urllib.urlopen("http://python.jobbole.com")
print dir(page)
html = page.read()
...
def getimg(html, name):
    ...
    <img src="http://i.meizitu.net/2016/04/01b01.jpg" >
    reg = r'src="(.*?\.jpg)"'
    ...
    for im in imglist:
        print im
        urllib.urlretrieve(im,
                           "E:\\python_aotu\\jpg\\save\\%s_%s.jpg" % (name, x))
